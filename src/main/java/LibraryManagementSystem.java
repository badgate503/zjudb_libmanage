...
public interface LibraryManagementSystem {
    ...
    ApiResult fetchMinMaxYear();
    /**
     * register a book to database, while whether to do commit is optional
     *
     * Note that:
     *      (1) if doCommit is false, the newly stored book will
     *          not be commited
     *
     */
    ApiResult fetchCategory();
    /**
     * register a book to database, while whether to do commit is optional
     *
     * Note that:
     ...
     * @param doCommit whether to commit.
     */
    ApiResult _storeBook(Book book, Boolean doCommit);
    /**
    ...
    ApiResult modifyCard(int cardId, Card card);
