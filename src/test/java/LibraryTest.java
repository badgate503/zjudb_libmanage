...
public class LibraryTest {
    ...
    public void bookRegisterTest() {
        ...
        //System.out.println(selectedResults.getResults().get(0).toString());
    ...
    {
        MyLibrary my = MyLibrary.createLibrary(library, 10, 100, 0);
        BookQueryConditions bqc = new BookQueryConditions();
        List<Book> books = ((BookQueryResults)library.queryBook(bqc).payload).getResults();
        ConsoleColor.logs("UT", JSONObject.toJSONString(books), "IFO");
